...
pub mod lifetime_2_to_the_8 {
    ...
    mod test {
        ...
        use crate::signature::{
            SignatureScheme,
            generalized_xmss::instantiations_poseidon_top_level::lifetime_2_to_the_8::SIGTopLevelTargetSumLifetime8Dim16Base4,
        };
        ...
        #[test]
        pub fn test_internal_consistency() {
            SIGTopLevelTargetSumLifetime8Dim16Base4::internal_consistency_check();
        }

        #[test]
        #[cfg(feature = "slow-tests")]
        pub fn test_correctness() {
            test_signature_scheme_correctness::<SIGTopLevelTargetSumLifetime8Dim16Base4>(
                213,
                0,
                SIGTopLevelTargetSumLifetime8Dim16Base4::LIFETIME as usize,
            );
            test_signature_scheme_correctness::<SIGTopLevelTargetSumLifetime8Dim16Base4>(
                4,
                0,
